...
namespace SiMay.RemoteMonitor.MainForm
{
    public partial class DesktopRecordViewerForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请选择用户目录~", "提示", 0, MessageBoxIcon.Exclamation);
                return;
            }
            paths.Clear();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("没有下一张了哦~", "提示", 0, MessageBoxIcon.Exclamation);
                return;
            }
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("没有上一张了哦~", "提示", 0, MessageBoxIcon.Exclamation);
                return;
            }
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
                ...
                if (File.Exists(path))
                {
                    ...
                    if (result == DialogResult.OK)
                    {
                        if (File.Exists(path))
                        {
                            ...
                            MessageBox.Show("记录已删除!", "提示", 0, MessageBoxIcon.Exclamation);
                        }
                    }
                }
            }
            ...
            {
                MessageBox.Show("当前没有可删除的记录!", "提示", 0, MessageBoxIcon.Exclamation);
            }
        }
