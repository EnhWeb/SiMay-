...
using SiMay.RemoteService.NewCore.Entitys;
...
namespace SiMay.RemoteService.NewCore.ControlService
{
    ...
    public class FileManager : ServiceManager, IServiceSource
    {
        ...
        public void SendFilelist(TcpSocketSaeaSession session)
        {
            ...
            try
            {
                var dirs = Directory.GetDirectories(pack.FilePath)
                ...
                var files = Directory.GetFiles(pack.FilePath)
